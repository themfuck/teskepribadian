...
export const initialState: UserState = {
  ...
  coins: {
    ...
    [SupportedChainId.APTOS]: APTOS_TESTNET_CoinInfo,
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(updateVersion, (state) => {
      // init chainId
      if (
        ![SupportedChainId.APTOS, SupportedChainId.APTOS_DEVNET, SupportedChainId.APTOS_DEVNET].includes(state.chainId)
      ) {
