...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.suiofhanako.xyz', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.suiofhanako.xyz', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.suiofhanako.xyz', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.suiofhanako.xyz', pathname: '/asset.gif' } }, false],
