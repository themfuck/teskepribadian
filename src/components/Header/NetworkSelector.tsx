      ...
      try {
        ...
        if (isProductionEnv()) {
          ...
          if (targetChain === SupportedChainId.APTOS_DEVNET) {
            window.open('https://app.hanakonfts.xyz/#/swap?chain=aptos_devnet')
            return
          } else if (targetChain === SupportedChainId.SUI_DEVNET) {
            window.open('https://app.hanakonfts.xyz/#/swap?chain=sui_devnet')
            return
          } else if (targetChain === SupportedChainId.SUI_TESTNET) {
            window.open('https://app.hanakonfts.xyz/#/swap?chain=sui_testnet')
            return
          } else {
